...
sim_stationary <- rpois(n = 30, lambda = 100)

sim_stationary_increase <- c(rpois(n = 25, lambda = 100),
                             rpois(n = 5, lambda = 100 * exp(0.1 * 1:5)))

sim_decrease_increase <- rpois(n = 25, lambda = 100 * exp(-0.05 * 0:24))
sim_decrease_increase <- c(sim_decrease_increase,
                           rpois(n = 5,
                                 lambda = sim_decrease_increase[25] * exp(.2 * 1:5)))
                             
sim <- data.frame(dates = dates,
